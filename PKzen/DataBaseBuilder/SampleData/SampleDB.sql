...
-- Species
INSERT INTO Species (Id, BaseHappiness, CaptureRate, Color, FlavorText, FormsSwitchable, GenderRate, Genera, Generation, Habitat, HasGenderDifferences, HatchCounter, IsBaby, IsLegendary, IsMythical)
VALUES (1, 50, 45, 'green', 'La semilla de su lomo está llena de nutrientes. La semilla brota a medida que el Pokémon crece.', 0, 1, 'Pokémon Semilla', 'generation-i', 'grassland', 0, 20, 0, 0, 0),
...
-- Pokemon
INSERT INTO Pokemon (Id, Name, BaseExperience, Weight, Height, IsShiny, Gender, SpeciesId)
VALUES (1, 'bulbasaur', 64, 69, 7, 0, 'male', 1),
...
-- Abilities
INSERT INTO Ability (Id, Name, Description, IsHidden, IsSelected)
VALUES (1, 'overgrow', 'Potencia sus movimientos de tipo Planta cuando le quedan pocos PS.', 0, 1),
...
-- PokemonAbility
INSERT INTO PokemonAbility (PokemonId, AbilityId)
VALUES
-- Bulbasaur
(1, 1),   -- Overgrow (normal)
...
-- SpeciesEggGroup
INSERT INTO SpeciesEggGroup (SpeciesId, EggGroupId)
VALUES (1, 1),
       (1, 7),
       (2, 1),
       (2, 7),
...
-- SpeciesType
INSERT INTO SpeciesType (Id, Slot, SpeciesId, TypeId)
VALUES (1, 1, 1, 12),  -- Bulbasaur: Grass
...
-- DamageRelation
INSERT INTO DamageRelation (SpeciesId, TypeId, RelationType)
VALUES
    -- Bulbasaur, Ivysaur, Venusaur (Grass/Poison)
    (1, 10, 2.0),
    (1, 3, 2.0),
    (1, 14, 2.0),
    (1, 15, 2.0), -- Debilidades
    (1, 11, 0.5),
    (1, 12, 0.5),
    (1, 2, 0.5),
    (1, 4, 0.5),  -- Resistencias
    (2, 10, 2.0),
    (2, 3, 2.0),
    (2, 14, 2.0),
    (2, 15, 2.0),
...
-- Cries
INSERT INTO Cries (Id, Latest, Legacy, SpeciesId)
VALUES (1, 'https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/latest/1.ogg', 'https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/legacy/1.ogg', 1),
...
-- Sprites
INSERT INTO Sprite (Id, Name, Icon, BackMale, BackFemale, BackShiny, BackShinyFemale, FrontMale, FrontFemale, FrontShiny, FrontShinyFemale, SpeciesId)
VALUES (1, 'official_artwork', 0, '', '', '', '', 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/1.png', '', 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/shiny/1.png', '', 1),
...
-- PokemonStat
INSERT INTO PokemonStat (Id, BaseStat, Effort, PokemonId, StatId)
VALUES
    -- Bulbasaur
    (1, 45, 0, 1, 1),
    (2, 49, 0, 1, 2),
...
-- Move
INSERT INTO Move (Id, Name, Accuracy, DamageClass, EffectChance, EffectText, CritRate, Drain, FlinchChance, Healing, MaxHits, MaxTurns, MinHits, MinTurns, StatChance, Power, Pp, Priority, Target, TypeId, PokemonId)
VALUES
    -- Bulbasaur
...
-- StatChange
INSERT INTO StatChange (Id, Change, StatId, MoveId)
VALUES (1, -1, 2, 2),  -- Growl reduces Attack
       ...
       (7, -1, 6, 18);
-- Sand Attack reduces Accuracy

-- EvolutionChain
INSERT INTO EvolutionChain (Id, BabyTriggerItem, SpeciesId)
VALUES (1, NULL, 1),  -- Bulbasaur line
...
INSERT INTO EvolutionFamilyMember (Id, PokemonEvolutionId, Name, Gender, HeldItem, Item, KnownMove, KnownMoveType, Location, MinAffection, MinBeauty, MinHappiness, MinLevel, NeedsOverworldRain, PartySpecies, PartyType, RelativePhysicalStats, TimeOfDay, TradeSpecies, EvolutionTrigger, TurnUpsideDown, EvolutionChainId)
VALUES
    -- Bulbasaur line
...
-- Variety
INSERT INTO Variety (Id, IsDefault, Name, SpeciesId)
VALUES (1, 1, 'bulbasaur', 1),
       (2, 1, 'ivysaur', 2),
       (3, 1, 'venusaur', 3),
       (4, 0, 'venusaur-mega', 3),
       (5, 0, 'venusaur-gmax', 3),
